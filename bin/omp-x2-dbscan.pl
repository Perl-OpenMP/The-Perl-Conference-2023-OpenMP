...
#define _POMP_ENV_UPDATE_NUM_THREADS_  char *num; num = getenv("OMP_NUM_THREADS"); omp_set_num_threads(atoi(num));

#define _POMP_REPORT_NUM_THREADS_  printf("\n%d OpenMP threads are being used ...\n",omp_get_num_threads());
